...
import { ArrowUpRight, Scissors, Play, X, Split } from "lucide-react";
...
function TrainTestSplitNode({ id, data, isConnectable }: any) {
    ...
    return (
        <>
            <div
                className={`relative w-[260px] rounded-none shadow-sm bg-white dark:bg-sidebar border border-dashed border-black/25 cursor-pointer ${loading ? "animate-pulse border-primary-500" : ""
                    } ${hasRun
            ...
            >
                ...
                <div className="p-4 space-y-1">
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] font-medium text-gray-500  tracking-wider">Shuffle</label>
                        <Select
                    ...
                    <div className="space-y-1">
                        <label className="text-[10px] font-medium text-gray-500  tracking-wider">Stratify</label>
                        <Select
                            value={stratify}
                        ...
                        >
                            <SelectTrigger className="text-xs w-full">
                                <SelectValue placeholder={columns.length ? "Select column" : "No columns"} />
                            </SelectTrigger>
                            <SelectContent>
