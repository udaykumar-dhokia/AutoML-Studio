  ...
  return (
    <>
      <div
        ...
        className={`relative w-60 rounded-md shadow-sm bg-white dark:bg-sidebar border-dashed border border-black/25 dark:border-white/15 cursor-pointer ${selectedOperation && selectedStrategy ? "" : "border-red-500"
          }`}
      >
