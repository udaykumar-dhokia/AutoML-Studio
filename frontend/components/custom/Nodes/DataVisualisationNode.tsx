...
const visualizationOptions: Record<string, string[]> = {
    "Univariate Analysis": ["Histogram", "Box Plot", "Bar Chart", "Pie Chart", "Count Plot"],
    "Bivariate Analysis": ["Scatter Plot", "Line Chart", "Bar Chart", "Box Plot", "Violin Plot", "Heatmap"],
...
function DataVisualisationNode({ id, data, isConnectable }: any) {
    ...
    const isValid = (() => {
        ...
        if (selectedAnalysisType === "Univariate Analysis") return !!selectedColumnX;
        if (selectedAnalysisType === "Bivariate Analysis") return !!selectedColumnX && !!selectedColumnY;
        if (selectedAnalysisType === "Multivariate Analysis") return !!selectedColumnX;
        return false;
    })();
    ...
    return (
        <>
            <div
                ...
                className={`relative w-[240px] rounded-lg shadow-sm bg-white dark:bg-sidebar border cursor-pointer ${isValid ? "" : "border-red-500"
                    }`}
            >
                ...
                <div className="p-4 space-y-3">
                    ...
                    {selectedAnalysisType && (
                        <>
                            <div className="space-y-1.5">
                                <label className="text-xs font-medium text-gray-600 dark:text-gray-400">
                                    {selectedAnalysisType === "Bivariate Analysis" ? "Column One" :
                                        selectedAnalysisType === "Multivariate Analysis" ? "Target Column" : "Column"}
                                </label>
                                <Select
                    ...
                    {!selectedAnalysisType && (
                        <p className="text-[10px] text-gray-400 italic text-center py-2">Select analysis type to configure</p>
                    )}
