...
const HandleMissingValuesDialog = ({
    ...
    const handleExecute = async () => {
        ...
        try {
            setLoading(true);
            const res = await axiosInstance.post("/operations/handle_missing_values", {
                id: datasetId,
                column: column,
                strategy: strategy,
            });
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[60vw] h-[80vh] flex flex-col gap-0 p-0">
                    ...
                    {result && (
                        <div className="space-y-4 animate-in fade-in zoom-in-95 duration-300">
                            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg border">
                                <span className="text-sm font-medium">Remaining Null Values:</span>
                ...
                <DialogFooter className="px-6 py-4 border-t mt-auto">
                    ...
                    <Button onClick={handleExecute} disabled={loading || !selectedColumn || !selectedStrategy}>
                        {loading ? (
